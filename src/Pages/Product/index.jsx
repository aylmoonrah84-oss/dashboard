  ...
  return (
    <div dir="rtl" className="w-full min-w-0 text-[#EDEFF7]">
      ...
      <div className="mb-6">
        ...
        <h1 className="text-2xl font-bold md:text-3xl">محصولات</h1>
        <p className="mt-2 text-sm text-[#8A93AB]">مدیریت و ایجاد محصولات فروشگاه</p>
      </div>
      ...
      <div className="rounded-2xl border border-white/10 bg-[#131826]/70 p-6 backdrop-blur-xl">
        <div className="mb-6 flex items-center justify-between border-b border-white/5 pb-5">
          <div>
            <h2 className="font-semibold text-[#EDEFF7]">محصولات فروشگاه</h2>
            <p className="mt-1 text-xs text-[#8A93AB]">محصولات موجود در فروشگاه را مدیریت کنید</p>
          </div>

          <button
            type="button"
            onClick={() => navigate("/dashboard/product/create")}
            className="rounded-xl bg-gradient-to-l from-[#6C5CE7] to-[#00D9FF] px-5 py-2.5 
